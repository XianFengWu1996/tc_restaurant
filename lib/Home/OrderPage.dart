                ...
                child: Column(
                  ...
                  children: [
                    orderDetails.comment!.isNotEmpty
                        ? Text(
                        'Special Instruction: ${orderDetails.comment}',
                        style: TextStyle(color: Colors.red))
                        : Container(),
                    SizedBox(
                      height: 10,
                ...
                children: [
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        handleStartLoading();
                        await FirebaseFirestore.instance.collection('newOrder').doc(widget.order.orderDetails.orderId).delete().then((value) async {
                          await restaurantBloc.removeOrder(widget.order.orderDetails.orderId!);
                          Navigator.pop(context);
                        }).catchError((error) {
                          setState(() {
